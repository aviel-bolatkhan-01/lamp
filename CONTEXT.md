...
# thelampgame.com DNS → Firebase Hosting (199.36.158.100), verified 2026-07-18.
# (GitHub Pages also builds from main but does NOT serve the domain — CNAME file is legacy.)
npx -y firebase-tools deploy --only hosting    # ships the site (no global firebase CLI — use npx)
